...
class AccountControllerTest {
    ...
    class CreateAccount {
        ...
        void returns201OnSuccess() throws Exception {
            given(accountService.createAccount(any(CreateAccountRequest.class), any(UserPrincipal.class)))
    ...
    class GetMyAccounts {
        ...
        void returns200() throws Exception {
            given(accountService.getMyAccounts(any(UserPrincipal.class)))
                    .willReturn(List.of(
        ...
        void returns200Empty() throws Exception {
            given(accountService.getMyAccounts(any(UserPrincipal.class))).willReturn(List.of());
    ...
    class GetAccount {
        ...
        void returns200() throws Exception {
            given(accountService.getAccount(any(UUID.class), any(UserPrincipal.class)))
                    .willReturn(buildResponse("1001-0000-000001", "Savings"));
    ...
    class GetBalance {
        ...
        void returns200() throws Exception {
            given(accountService.getBalance(any(UUID.class), any(UserPrincipal.class)))
